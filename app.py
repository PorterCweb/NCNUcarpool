        ...
        if text =='目前有哪些共乘（已有司機）？':
            if web_driver_len != 1:
                ...
                for i in range(1,web_driver_len):
                    ...
                    now_datetime = datetime.now()
                    now_date = now_datetime.strftime("%Y-%m-%d")
                    if driver_case_date>=now_date or driver_case_launchdate == driver_case_date:
                        try :
            ...
            if web_passenger_len != 1:
                ...
                for i in range(1,web_passenger_len):
                    ...
                    now_datetime = datetime.now()
                    now_date = now_datetime.strftime("%Y-%m-%d")
                    if passenger_case_date>=now_date or passenger_case_launchdate == passenger_case_date:
                        try :
